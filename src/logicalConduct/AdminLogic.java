...
//	private  SearchAboutPost searchFromDB=new SearchAboutPost();
	...
	{
		sql="insert into user_info values('"+user.getUserId()+"','"+user.getUserName()+"','"+user.getPassword()+"','"+user.getUserType()+"" +
	...
	//更新用户
	public boolean updateUser(int userId,String userName,String userPasswd,String email,String phone)
		{
			connection=new ConnectDB();
			System.out.println("执行updateUser，userName="+userName+"userPasswd"+userPasswd+"email"+email+"phone"+phone);
			sql="update user set  userName='"+userName+"' ,password='"+userPasswd+"' ,email='"+email+"' ,phone='"+phone+"' where userId='"+userId+"'";
			boolean flag=connection.executeUpdate(sql);		
			connection.close();
	...
	{
		connection=new ConnectDB();
		sql="insert into post(postId, unitId,userId,postName,createTime) values('"+p.getPostId()+"','"+p.getUnitId()+"','"+p.getUserId()+"','"+p.getPostName()+"','"+p.getCreateTime()+"')";
		boolean flag=connection.executeUpdate(sql);		
		connection.close();
		return flag;
	}
	...
	{
		connection=new ConnectDB();
		sql="update post set  postName='"+paste_name+"' where postId='"+id+"'";
		boolean flag=connection.executeUpdate(sql);		
		connection.close();
	...
	{
		connection=new ConnectDB();
		sql="insert into unit  values('"+u.getUnitId()+"','"+u.getUnitName()+"','"+u.getUnitTypeId()+"')";
		boolean flag=connection.executeUpdate(sql);
	...
	{
		connection=new ConnectDB();
		sql="update unit set unitName='"+u.getUnitName()+"', unitTypeId='"+u.getUnitTypeId()+"' where unitId='"+u.getUnitId()+"'";
		boolean flag=connection.executeUpdate(sql);
	...
	{
		connection=new ConnectDB();
		sql="insert into adtype values('"+p.getAdTypeId()+"','"+p.getAdTypeName()+"')";
		boolean flag=connection.executeUpdate(sql);		
		connection.close();
		return flag;
	}
	...
	{
		connection=new ConnectDB();
		sql="update adtype set adTypeName='"+typeName+"' where adTypeId='"+id+"'";
		boolean flag=connection.executeUpdate(sql);		
		connection.close();
	...
	//获取所有单位类别信息
		...
		{
			connection=new ConnectDB();
			sql="insert into unittype values('"+p.getUnitTypeId() +"','"+p.getUnitTypeName()+"')";
			boolean flag=connection.executeUpdate(sql);		
			connection.close();
			return flag;
		}
		...
		{
			connection=new ConnectDB();
			sql="update unittype set  unitTypeName='"+typeName+"' where unitTypeId='"+id+"'";
			boolean flag=connection.executeUpdate(sql);		
			connection.close();
			return flag;
		}
