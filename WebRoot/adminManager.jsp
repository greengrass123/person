...
*/                                          
 ...
 <form action="AdminManagerLogical?info=auditInfo" method="post"  id="form1"  name="formName">
 <table width="1000">
 
 <tr>  
   <td align="center">
       <input type="radio" value="未审核"  name="audit"/>未审核 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <input type="radio" value="已审核" name="audit"/>已审核
   </td>
    <td>
     <select name="adType"  id="adType"  >
  	...
  	<td>
  	<select  name="pasteType"  id="pasteType"  >
   ...
   <td>
 		<input type="button" value="展示"   onclick=" check(document.formName.audit);"/> &nbsp;								
   </td> 	 
 </tr>
 <tr>  </tr>
 <tr >
 ...
 <td id="more" >  
         ...
         <ul id="squares" class="bubblewrap">
          ...
          for(int i=0;i<noauditlist.size();i++)
          {
           ...
           %>
           <li><img src="<%=p.getPicAddr()%>" width="200" height="200"/>          
           </li>
           <span>
          ...
          for(int i=0;i<auditlist.size();i++)
          {
           ...
           <span>         
           <a href="AdminManagerLogical?info=delInfo&adId=<%=p.getAdId() %>">删除</a>
            </span>
...
jQuery(document).ready(function($){
	...
	$('ul#squares').imgbubbles({factor:1.85}) //add bubbles effect to UL id="squares"
})
}
